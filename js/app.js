...
Se utiliza function() porque se necesita ingresar a los datos
del constructor
*/
Seguro.prototype.cotizarSeguro = function () {
    ...
    */
    ...
    const final = Math.floor(cantidad);
...
UI.prototype.mostrarResultado = (seguro, total) => {
    ...
    setTimeout(() => {
        ...
        // Se borra el spinner y luego se muestra el resultado
...
function cotizarSeguro(evt) {
    ...
    //Utilizar el prototype en el seguro
